...
<?php 
/*
* Template Name: Blog Post In Arabic
*/
get_header(); ?>
<style>
   body{
...
$paged = ( get_query_var( 'paged' ) ) ? absint( get_query_var( 'paged' ) ) : 1;
  ...
  $args = array(
    'post_type' => 'arpost', // enter custom post type
    'orderby' => 'date',
    'order' => 'DESC',
    'posts_per_page'   => 5,
    'post_status'      => 'publish',
    'paged' => $paged,
    'orderby' => array( 'date' => 'ASC', 'menu_order' => 'DESC' )
  );
...
<div id="content">
        ...
        $paged = ( get_query_var( 'paged' ) ) ? absint( get_query_var( 'paged' ) ) : 1;
        $args = array(
          'post_type' => 'arpost', // enter custom post type'orderby' => 'date',
        ...
        <div class="feature-inner">
            <a  href="<?php echo esc_url(the_post_thumbnail_url()); ?>"><img class="img-responsive" alt="" src="<?php echo esc_url(the_post_thumbnail_url()); ?>"></a>
        </div>
        
            <div class="post-content"> <?php echo wp_trim_words( get_the_content(), 40, '...' ); ?> </div>
        <div class="entry-more">
        <div class="pull-right">
            <a class="btn btn-common" href="<?php echo esc_url(get_permalink()); ?>">إقرأ المزيد <i class="fa fa-arrow-left"></i></a>
        </div>
